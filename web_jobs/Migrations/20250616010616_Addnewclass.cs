        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserFacebook = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    UserDesiredJob = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CertificateYear = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CertificateName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PrizeYear = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PrizeDesc = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_CandidateProfiles_UserID", x => x.UserID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JobType_Name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SaveStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Applications", x => new { x.Job_ID, x.User_ID });
                    table.ForeignKey(
                        name: "FK_Applications_CandidateProfiles_User_ID",
                        column: x => x.User_ID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobTags", x => new { x.Job_ID, x.Tag_ID });
                    table.ForeignKey(
                        name: "FK_JobTags_Jobs_Job_ID",
                        column: x => x.Job_ID,
                        principalTable: "Jobs",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobTags_Tags_Tag_ID",
                        column: x => x.Tag_ID,
                        principalTable: "Tags",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
